$p  = fisher_test_controls(1,9,11,3);
print "$p\n";
sub hypergeometric
...
{
my $accumulated_p_val=0;my @table_2_x_2=@_;while($table_2_x_2[0]>=0 and $table_2_x_2[3]>=0){$accumulated_p_val=$accumulated_p_val+hypergeometric(@table_2_x_2);$table_2_x_2[1]=$table_2_x_2[1]+1;$table_2_x_2[0]=$table_2_x_2[0]-1;$table_2_x_2[2]++;$table_2_x_2[3]--;}return(1- $accumulated_p_val);}
